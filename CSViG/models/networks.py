...
from models.ChangeVIG import ChangeGNNV1, ChangeGNNV2
###############################################################################
# Helper Functions
###############################################################################
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    if args.net_G == "Unet":
        net = Unet(input_nbr=3, label_nbr=args.n_class)
    ...
    # CSViG
    elif args.net_G == "CSViGV1":
        net = ChangeGNNV1(embed_dim=args.embed_dim)
    elif args.net_G == "CSViGV2":
        net = ChangeGNNV2(embed_dim=args.embed_dim, img_size=args.img_size)
